...
export const styles = {
  ...
  loadingMark: "mx-auto grid size-[42px] place-items-center rounded-full border-2 border-primary/30 border-t-primary text-sm text-primary animate-[spin_900ms_linear_infinite]",
