...
export const styles = {
  ...
  canvasNotice: "absolute right-3 top-3 z-10 rounded-full border border-border bg-card px-3 py-1.5 text-2xs font-medium text-primary shadow-sm",
  ...
  statusFooter: "relative flex min-h-9 items-center justify-between gap-3 border-t border-border bg-card px-4 text-3xs font-medium text-muted-foreground",
