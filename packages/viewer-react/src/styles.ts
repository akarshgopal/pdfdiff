...
export const styles = {
  ...
  workspaceBar: "flex h-13 min-h-13 items-center justify-between gap-4 border-b border-border bg-card px-5 max-[820px]:px-3.5",
  ...
  pageRail: "min-h-0 overflow-y-auto overflow-x-hidden border-r border-sidebar-border bg-sidebar px-2.5 py-4",
  railHeader: "mb-3 flex flex-col gap-2",
  railHeading: `${ui.caps} m-0 px-0.5 text-sidebar-foreground`,
  ...
  pageButton: `${ui.focus} mb-2 w-full cursor-pointer rounded-xl border border-transparent bg-transparent p-1.5 text-left text-sidebar-foreground transition-colors hover:bg-card/75`,
  ...
  railNote: "px-1 py-2 text-center text-3xs text-muted-foreground",
  ...
  paper: "relative mx-auto min-h-[520px] w-[min(820px,100%)] origin-top overflow-hidden rounded-xl border border-border bg-background",
  ...
  paperEmpty: "grid min-h-[520px] place-items-center p-[30px] text-center text-xs text-muted-foreground",
  ...
  changeOverlayLegend: "absolute bottom-4 left-4 inline-flex items-center gap-1.5 rounded-lg border border-foreground/10 bg-card/90 px-2.5 py-1.5 text-3xs font-semibold text-muted-foreground",
